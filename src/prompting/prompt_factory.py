...
from src.prompting.retrobust import nq_with_retrieval_at1, nq_with_retrieval_at5, nq_with_retrieval_at10, nq_with_retrieval_mix, \
    nq_no_retrieval
...
PromptFactoryDict: Dict[str, str] = {
    ...
    "nq_with_retrieval_at5": nq_with_retrieval_at5,
}
